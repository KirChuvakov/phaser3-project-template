...
Snake = function(game, spriteKey, x, y) {
    ...
    this.head = this.addSectionAtPosition(x,y,true);
    this.head.name = "head";
...
Snake.prototype = {
     ...
     */
    addSectionAtPosition: function(x, y,isHead=false) {
        //initialize a new section
        var sec = isHead? this.game.add.sprite(x, y, "head"):this.game.add.sprite(x, y, this.spriteKey)
